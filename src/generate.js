    ...
    */
    var promise_all_buttons = view_loader.load("clientside-view-button")
        .then((build)=>{
            ...
            var promise_switch_signup = build({
            ...
            var promise_switch_login = build({
